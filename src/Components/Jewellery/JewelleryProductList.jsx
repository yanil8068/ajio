...
export default function JewelleryProductsList () {
  ...
  const [isFilterByRatingBelow3, setIsFilterByRatingBelow3] = useState(false);
  ...
  const handleRatingAbove3FilterChange = (e) =>
    setIsFilterByRatingAbove3(e.target.checked);
  const handleRatingBelow3FilterChange = (e) =>
    setIsFilterByRatingBelow3(e.target.checked);
    ...
    <div>
      ...
      {isLoading ? (
        ...
        <div className="lg:flex lg:justify-evenly xl:flex xl:justify-evenly 2xl:flex 2xl:justify-evenly ">
          <div className="AllFiltersSmallScreen block lg:hidden bg-gray-400  border-black border-2 ">
          ...
          <div className="flex justify-center ">
            <div className="grid grid-cols-3 sm:grid-cols-3 gap:3 md:gap-4 p-4">
              {products.map((d) => (
                <div
                  key={d.id}
                  className="rounded-lg shadow-md overflow-hidden bg-white p-1 md:p-3 w-28 md:w-64 lg:w-80 h-80 md:h-auto lg:h-[500px]"
                >
                  <Link to={`/mens/${d.id}`}>
                    <img
                      src={d.image}

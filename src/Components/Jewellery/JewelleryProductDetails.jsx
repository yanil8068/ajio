    ...
    <div className="p-4">
      <div className="flex flex-col lg:flex-row gap-6 mb-8">
        ...
        <div className="flex-grow w-full lg:w-1/2 flex flex-col">
          ...
          <p className="text-md font-medium text-gray-700 mb-2">Brand: {product.brand || 'Ajio Product'}</p>
          <p className="text-md font-medium text-gray-700 mb-4">Category: {product.category || 'Ajio Product'}</p>
          <div className="mb-4">

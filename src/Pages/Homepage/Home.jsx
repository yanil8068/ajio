...
import { topBannerImg, topCarouselImg, seasonStyleImg, newTodayImg, discountBannerImg, fallWinterBannerImg, differentProductImg, luxeBanner, ajioCareBanner,
  electronicsBannerImages, jewelleryImg
...
function Home() {
  return (
    <div>
      ...
      <div className='my-6'>
        <h2 className='py-2 text-center text-3xl text-[#767968] font-bold'>Season's It Styles</h2>
        <Carousel images={seasonStyleImg} />
      </div>

      {/* womens:new today, gone tommorrow section */}
      <div className='my-10'>
        <h2 className='py-2 text-center text-3xl text-[#4a82bd] font-bold'>New Today, Gone Tomorrow</h2>
        <Carousel images={newTodayImg} />
      </div>

      {/* jewlllery carousel */}
      <div className='my-10'>
        <h2 className='py-2 text-center text-3xl text-[#bd804a] font-bold'>New For You</h2>
        <Carousel images={jewelleryImg} />
      </div>

      {/* electronics */}
      <div className='my-10'>
        <h2 className='py-2 text-center text-3xl text-[#7897df] font-bold'>Trending Product</h2>
